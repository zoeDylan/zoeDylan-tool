...
const _wx = (() => {
    ...
    function setShareConfig(op) {
        if (isAuthorization) {
            ...
            let
                ...
                shareSuccess = typeof op.success == 'function' ? op.success : _op.shareSuccess,
                shareCancel = typeof op.cancel == 'function' ? op.cancel : _op.shareCancel;
    ...
    function setShareSuccess(fn) {
        typeof fn == 'function' ? setShareConfig({
            success: fn
        }) : '';
